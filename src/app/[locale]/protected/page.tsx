  ...
  return (
    <div className="bg-slate-100 h-screen flex-1 w-full flex flex-col gap-12">
      <div className="w-full">
        <div className="bg-accent text-center text-sm p-3 px-5 rounded-md text-foreground flex gap-3 items-center">
      ...
      <div className="flex flex-col gap-2 items-center">
        <h2 className="font-bold text-center text-2xl mb-4">{t("userDetails")}</h2>
        <div className="text-xs text-center font-mono p-3 rounded border max-h-32 overflow-auto">
