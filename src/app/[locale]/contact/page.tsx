...
const page = () => {
  return (
    <>
      <section className="bg-gradient-to-b from-stone-800 to bg-stone-400 h-screen py-3 ">
        <div className="flex-1 w-[99vw] mt-16 py-1 px-3 rounded-xl flex flex-col mx-auto items-center justify-center lg:mt-24">
          ...
          <div className="relative mt-3 flex-1 text-stone-300 font-primary ">
            <h1 className=" mb-2 text-4xl  text-center lg:mt-6 lg:text-[5rem]">
              Claudia & Frank
            </h1>
            ...
            <h1 className=" text-2xl text-center text-neutral-300 lg:mt-6 lg:text-[4em] lg:leading9">
