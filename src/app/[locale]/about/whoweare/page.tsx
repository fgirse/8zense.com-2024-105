      ...
      <section className="mx-auto min-h-screen w-[100%]">
        <div className="flex flex-col items-center justify-center container">
          ...
          <div className="relative top-3 w-28 h-28">
            <Image src={Logo01} alt="Logo 8zense" sizes="100vw" width={200} height="200" />
          </div>
          ...
          <h1 className="mt-12 text-amber-500 text-[2.336rem] uppercase font-bold text-center leading-10 sm:mt-60 md:text-8xl md:font-black lg:-mt-1 lg:text-[9rem]">
            {t("Title_Whoweare")}
          </h1>

          <h2 className="mb-3 mt-3 text-[1.25rem] md:text-[2.33rem] lg:text-[7rem]">
            {t("SubTitle_Whoweare")}
          </h2>
          ...
          <div className="-py-12 relative w-full h-44                                                          transform scale-110 lg:w-20vw lg:text-6xl">
          ...
          <section className="mt-12">
            <div className="flex flex-row items-baseline justify-start">
              ...
              <span className="text-6xl align-text-bottom bg-yellow-600 text-center h-16 w-16 rounded-full text-white lg:text-[14rem]">
                &#x2714;
              </span>
            </div>
          </section>
          ...
          <section className="">
            <div className="flex flex-row items-baseline justify-start">
              <h1 className="{styles.headingA} text-left font-extrabold uppercase text-greey-600  text-5xl leading-3 md:text-6xl lg:text-[7rem]">
                individuell{""}
              </h1>
              <span className="text-6xl align-text-bottom bg-yellow-600 text-center h-16 w-16 rounded-full text-white lg:text-[14rem]">
                &#x2714;
