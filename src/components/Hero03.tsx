...
<div className="bg-stone-100 px-4 lg:px-6 py-10">
        ...
        <div className="hs-carousel-slide">
          <div className="h-[30rem] md:h-[calc(100vh-106px)]  flex flex-col bg-[url('/assets/images/Kica_Welpe-Photoroom.jpg')] bg-cover bg-center bg-no-repeat lg:bg-contain lg:text-slate-700">
            <div className="mt-auto w-2/3 md:max-w-lg ps-5 pb-5 md:ps-10 md:pb-10">
              ...
              <span className="block font-primary  text-slate-500 text-xl md:text-3xl">Kica als Welpe</span>
              <div className="mt-5">
        ...
        <div className="hs-carousel-slide">
          <div className="h-[30rem] md:h-[calc(100vh-106px)]  flex flex-col bg-[url('/assets/images/Portrait_Kica-01-Photoroom.jpg')] bg-cover bg-center bg-no-repeat lg:bg-contain lg:text-slate-700">
            <div className="mt-auto w-2/3 md:max-w-lg ps-5 pb-5 md:ps-10 md:pb-10 ">
              ...
              <span className="block font-primary text-slate-700 text-xl md:text-3xl lg:text-3xl lg:texf-slate-600">4 jährige Hündin aus Monte Cordova</span>
              <div className="mt-5">
  ...
  <p className="lg:mt-24 font-primary lg:text-[1.33rem] lg:w-[33vw] text-base md:text-lg text-slate-700 my-4 md:my-6 lg:text-2xl ">{t("text01_Hero3")}</p>
