  ...
  return (
    <section id="section-Hero" className="bg-slate-800 full flex-col items-center ">
      ...
      <div className="  flex min-h-screen flex-col items-center">
        ...
        <h1 className="mb-3 headingE {bowlbySC_init.className} relative text-center -top-[3vh] text-[8.0rem] uppercase leading-3 text-orange-300 sm:text-8xl md:text-8xl md:top-3 lg:top-[8vh] lg:text-[15.33rem] lg:text-neutral-600  xl:text-[14.33rem] xl:top-32">
          {t("Title")}
        </h1>

        <p className="headingE relative uppercase top-6 text-center text-[2.2663rem] leading-8 text-neutral-100 sm:text-4xl md:top-3 md:tet-4xl lg:mb-4 lg:top-52 lg:text-center lg:text-5xl lg:text-neutral-600">
          {t("postTitle")}
        </p>
        </div>
